...
var file_main_main_proto_rawDesc = []byte{
	...
	0x38, 0x0a, 0x07, 0x49, 0x73, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x12, 0x14, 0x2e, 0x61, 0x75, 0x74,
	...
	0x63, 0x68, 0x69, 0x72, 0x2e, 0x73, 0x61, 0x6e, 0x64, 0x6a, 0x6d, 0x61, 0x2e, 0x76, 0x31, 0x3b,
	0x73, 0x61, 0x6e, 0x64, 0x6a, 0x6d, 0x61, 0x76, 0x31, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
var file_main_main_proto_depIdxs = []int32{
	...
	1, // 1: auth.Auth.IsAdmin:input_type -> auth.IsAdminRequest
	3, // 2: auth.Auth.Register:output_type -> auth.RegisterResponse
	2, // 3: auth.Auth.IsAdmin:output_type -> auth.IsAdminResponse
