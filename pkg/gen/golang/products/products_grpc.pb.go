...
func (c *productClient) GetAllProducts(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetAllProductsResponse, error) {
...
func (UnimplementedProductServer) GetAllProducts(context.Context, *emptypb.Empty) (*GetAllProductsResponse, error) {
